...
(function(){
  var lastComment, scrollTo, htmlEncode, textElement, authorElement, success, formSelector, extractData;
  lastComment = null;
  ...
  textElement = function(comment){
    return $("<div class='text' />").append(htmlEncode(comment.text));
  };
  authorElement = function(comment){
    return $("<div class='author'/>").text(comment.author);
  };
  success = function(newComment){
    ...
    if (typeof newComment === 'object') {
      ...
      newCommentElement.append(textElement(newComment)).append(authorElement(newComment));
